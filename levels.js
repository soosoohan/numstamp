...
nstamp_006: {
  ...
  deck: [2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4]
},
nstamp_008: {
  grid: { rows: 3, cols: 5 },
  rocks: [
  ...
  deck: [2,2,4,4,8,2,2,4,4,8,2,2,4,4,8,2,2,4,4,8,2,2,4,4,8,2]
},
nstamp_009: {
  grid: { rows: 4, cols: 3 },
  rocks: [
  ...
  deck: [4,2,8,4,2,8,4,2,8,4,2,8,4,2,8,4,2,8,4,2,8,4,2,8,4,2]
},
    nstamp_010: {
    grid: { rows: 4, cols: 4 },
    rocks: [
  ...
  nstamp_012: {
    ...
    deck: [2,2,4,8,2,2,4,8,2,2,4,8,2,2,4,8,2,2,4,8,2,2,4,8]
  },
  nstamp_013: {
    grid: { rows: 4, cols: 5 },
    rocks: [
  ...
  nstamp_015: {
    ...
    deck: [2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8]
  },
  nstamp_016: {
    grid: { rows: 5, cols: 3 },
    rocks: [
    ...
    deck: [4,2,2,8,4,2,2,8,4,2,2,8,4,2,2,8,4,2,2,8]
  },
  nstamp_017: {
    grid: { rows: 5, cols: 4 },
    rocks: [
  ...
  nstamp_019: {
    ...
    deck: [2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8,2,4,8]
  },
  nstamp_020: {
    grid: { rows: 5, cols: 5 },
    rocks: [
    ...
    deck: [4,4,2,8,4,4,2,8,4,4,2,8,4,4,2,8,4,4,2,8,4,4,2,8,4,4,2,8]
  }
