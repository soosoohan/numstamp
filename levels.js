...
nstamp_009: {
  ...
  nstamp_020: {
    ...
    deck: [2,4,8,2,8,4,4,2,8,2,4,4,8,2,4,8,8,2,4,2,8]
  },
  nstamp_022: {
    grid: { rows: 3, cols: 4 },
    rocks: [
    ...
    deck: [4,2,8,4,4,2,8,2,4,8,4,2,2,8,4,8,2,4,4,8,2,4,8,2,4,8]
  },
  nstamp_023: {
    grid: { rows: 3, cols: 5 },
    rocks: [
    ...
    deck: [2,8,4,2,4,8,2,4,4,8,2,8,4,2,8,4,4,2,8,2,4,8,4,2,8,4,2,4,8,2]
  },
  nstamp_024: {
    grid: { rows: 4, cols: 3 },
    rocks: [
    ...
    deck: [8,4,2,🍎,4,8,2,4,4,🍎,8,2,8,4,2,4,8,🍎,4,2,8,2,🍎,4,8,4,2,8,4,2]
  },
  nstamp_025: {
    grid: { rows: 4, cols: 4 },
    rocks: [
    ...
    deck: [4,8,2,4,2,🍎,8,4,4,2,8,4,2,8,4,🍎,2,8,4,4,2,8,2,4,8,2,4,8,4,2,8,4]
  },
  nstamp_026: {
    grid: { rows: 4, cols: 5 },
    rocks: [
    ...
    deck: [2,4,8,4,2,8,4,2,4,8,2,4,8,4,2,8,2,4,4,8,2,4,8,4,2,8,4,2,8,4,2,8,4,2]
  },
  nstamp_027: {
    grid: { rows: 5, cols: 3 },
    rocks: [
    ...
    deck: [4,2,8,4,8,2,4,4,8,2,4,8,2,4,8,4,2,8,4,2,8,4,4,2,8,4]
  },
  nstamp_028: {
    grid: { rows: 5, cols: 4 },
    rocks: [
    ...
    deck: [2,4,8,2,4,4,8,2,8,4,2,4,8,4,2,8,2,4,8,4,2,4,8,2,8,4,2,8,4,2]
  },
  nstamp_029: {
    grid: { rows: 5, cols: 5 },
    rocks: [
    ...
    deck: [4,2,8,4,2,4,8,2,4,8,4,2,8,4,2,8,4,4,2,8,2,4,8,4,2,8,4,2,4,8,2,4,8,4,2,8,4,2]
  },
  nstamp_030: {
    grid: { rows: 3, cols: 3 },
    rocks: [
